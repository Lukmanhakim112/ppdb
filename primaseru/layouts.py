            ...
            Fieldset(None,
                TabHolder(
                    Tab('Data Diri',
                        ...
                        Row(
                            Div(Field('nisn', css_class='form-control-sm'), css_class="col-sm-3"),
                            Div(Field("nik", css_class='form-control-sm'), css_class="col-sm-5"),
                            Div(Field('no_kk', css_class='form-control-sm'), css_class="col-sm-4"),
                        ),
                        Row(
                    ...
                    Tab('Alamat',
                        ...
                        Row(
                            Div(Field('city', css_class='form-control-sm'), css_class="col-sm-12"),
                        ),
                        Row(
                            Div(Field("kecamatan", css_class='form-control-sm'), css_class="col-sm-4"),
